...
extern void onevent_kboard(int16_t inkey, int8_t instate, int8_t inmods, float intimestamp);
extern void onevent_mouse_button(int16_t inbutton, int8_t instate, int8_t inmods, float intimestamp);
